                            ...
                            <Alert className="bg-amber-500/10 border-amber-500/20">
                                ...
                                <AlertDescription className="text-amber-300/80">
                                    <div className='font-semibold text-amber-400 mb-1'>
                                        ...
                                        {currentProjectCount === 2 ? "This will be your last free project. Upgrade to Pixxel Pro for unlimited projects." : "Free plan is limited to 3 projects. Upgrade to Pixxel Pro to more projects."}
                                    </div>
                                </AlertDescription>
                            </Alert>
                        )}
