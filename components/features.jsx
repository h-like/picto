...
const FeaturesCard = ({ icon, title, description, delay = 0 }) => {
    ...
    return (
        <div ref={ref} className={`backdrop-blur-lg bg-white/5 border border-white/10 rounded-2xl p-8 transition-all 
            ...
            <div className='max-w-7xl mx-auto px-6'>
                ...
                <div className='grid md:grid-cols-2 lg:grid-cols-3 gap-8'>
                    {features.map((feature, index) => {
                        return <FeaturesCard key={index} {...feature} delay={index * 500} />;
                    })}
                </div>
            </div>
        </section>
