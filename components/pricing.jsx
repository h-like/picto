...
toast.error("Something went wrong" + error.message)
    ...
    return (
        <div
            ...
            cursor-pointer ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
        ...
        >
            ...
            {featured && (<div className='absolute -top-4 left-1/2 transform -translate-x-1/2'>
            ...
            <div className='max-w-6xl mx-auto px-6'>
                <div className='text-center mb-16'>
                    <h2 className='text-5xl font-bold text-white mb-6'>
                        Simple{" "} <span className='bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent mb-6'>
