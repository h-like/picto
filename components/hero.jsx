...
import { Sparkles, Check, Aperture, Zap } from "lucide-react";
...
const HeroDemoInterface = () => {
  ...
  return (
    <div className="perspective-1000 w-full max-w-4xl mx-auto mt-16 relative z-20" ref={cardRef}>
      <motion.div
      ...
      >
        ...
        >
          ...
          <div>
            <div className="text-[10px] text-gray-400 uppercase tracking-wider">AI Confidence</div>
        ...
        >
           <div className="flex items-center gap-2 mb-1">
             ...
             <span className="text-xs font-bold text-white">GPU Acceleration</span>
           </div>
...
const HeroSection = () => {
  ...
  return (
    <section className="min-h-screen flex flex-col items-center justify-center relative overflow-hidden pt-20 pb-20">
      {/* 배경 그라디언트 효과 (옵션) */}
